...
*3) outcomes
	global acuerdos acuerdo_estcom
...
esttab using "../Tables/unobservables.tex", replace  b(%9.4f) se(%9.4f) se  star(* 0.10 ** 0.05 *** 0.01) ///
s(N r2 munfe yearfe clustermun , fmt(%11.2gc 3) ///
 label("Observations" "R2" "Mun. FE" "Year FE" "State Cluster S.E.")) ///
keep(yhat ) ///
coeflabel(yhat "Fitted value") ///
