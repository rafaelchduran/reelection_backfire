...
tex \centering
tex \caption{Effect of 2014 Term Limit Reform on Security Cooperation Agreements with the Governor}
tex \label{tab:interaction_sec_preferences}
tex \scalebox{0.70}{    
tex \begin{tabular}{lcccccccc}  
tex \hline \hline       
tex \\ \multicolumn{9}{l}{Dependent variable: Pretreatment Citizens Preferences}\\
tex : & Narco  & Insecurity & Punishment & Private sec expenditure  & Poverty & Unemployment & Inflation & Natural disaster \\
...
tex \centering
tex \caption{Effect of 2014 Term Limit Reform on Security Cooperation Agreements with the Governor}
tex \label{tab:interaction_sec_preferences_aggregate}
tex \scalebox{0.70}{    
tex \begin{tabular}{lcccccccc}  
tex \hline \hline       
tex \\ \multicolumn{9}{l}{Dependent variable: Pretreatment Citizens Preferences}\\
...
coefplot   (est4, rename((1) = ".") mfcolor(white)  msize(large) mcolor(green) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est5, rename((1) = ".")  mfcolor(white)  msize(large) mcolor(blue) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est6, rename((1) = ".") mfcolor(white) msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 , ///
 horizontal scheme(s1color)  xline(0)  ///
ytitle(" ")  xtitle(" ") ///
...
coefplot(est16, rename((1) = ".") mfcolor(white)  msize(large) mcolor(green) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est17, rename((1) = ".") mfcolor(white) msize(large) mcolor(blue) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est18, rename((1) = ".") mfcolor(white)  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 , ///
 horizontal scheme(s1color)  xline(0)  ///
ytitle(" ")  xtitle(" ") ///
...
graph save "../Figures/water.gph", replace
 ...
 coefplot (est31, rename((1) = ".") mfcolor(white) msize(large) mcolor(green) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est32, rename((1) = ".") mfcolor(white) msize(large) mcolor(blue) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est33, rename((1) = ".") mfcolor(white) msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
   , ///
 horizontal scheme(s1color)  xline(0)  ///
ytitle(" ")  xtitle(" ") ///
...
graph save "../Figures/education.gph", replace
 ...
 coefplot (est34, rename((1) = ".") mfcolor(white) msize(large) mcolor(green) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est35, rename((1) = ".") mfcolor(white) msize(large) mcolor(blue) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est36, rename((1) = ".") mfcolor(white) msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
   , ///
 horizontal scheme(s1color)  xline(0)  ///
ytitle(" ")  xtitle(" ") ///
