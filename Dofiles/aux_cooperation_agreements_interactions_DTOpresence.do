...
esttab est*, keep(L.reform cL.reform#c.distEntradasPrinc cL.reform#c.hayCarteles  cL.reform#c.nCarteles) t star(* 0.1 ** 0.05 *** 0.01)
...
*========================================================================
**2) Robustness: Hay Carteles. For Chaisemartin I can only do this by subsetting the data
...
tex & \multicolumn{1}{c}{No Cartel Presence} & \multicolumn{1}{c}{Cartel Presence$^{a}$} \\
...
*========================================================================
**2) Robustness: Chaisemartin et al (subsetting data)
...
texdoc init  "../Tables/chaisemarting_estimates_DVmandounico_by_num_Carteles.tex", replace force
tex \begin{table}[htbp]\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
tex \centering
