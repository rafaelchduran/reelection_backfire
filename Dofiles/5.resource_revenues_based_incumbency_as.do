...
graph export "../Figures/participaciones_allyears.png", as(png) replace
graph export "../Figures/participaciones_allyears.pdf", as(pdf) replace
graph export "../Figures/participaciones_allyears.tif", as(tif) replace
graph save "../Figures/participaciones_allyears.gph", replace
restore
...
graph export "../Figures/participables_allyears.png", as(png) replace
graph export "../Figures/participables_allyears.pdf", as(pdf) replace
graph export "../Figures/participables_allyears.tif", as(tif) replace
graph save "../Figures/participables_allyears.gph", replace
restore
...
graph export "../Figures/fomento_allyears.png", as(png) replace
graph export "../Figures/fomento_allyears.pdf", as(pdf) replace
graph export "../Figures/fomento_allyears.tif", as(tif) replace
graph save "../Figures/fomento_allyears.gph", replace
restore
...
graph export "../Figures/aportaciones_allyears.png", as(png) replace
graph export "../Figures/aportaciones_allyears.pdf", as(pdf) replace
graph export "../Figures/aportaciones_allyears.tif", as(tif) replace
graph save "../Figures/aportaciones_allyears.gph", replace
restore
...
graph export "../Figures/fortalecimiento_allyears.png", as(png) replace
graph export "../Figures/fortalecimiento_allyears.pdf", as(pdf) replace
graph export "../Figures/fortalecimiento_allyears.tif", as(tif) replace
graph save "../Figures/fortalecimiento_allyears.gph", replace
restore
...
graph export "../Figures/infra_social_allyears.png", as(png) replace
graph export "../Figures/infra_social_allyears.pdf", as(pdf) replace
graph export "../Figures/infra_social_allyears.tif", as(tif) replace
graph save "../Figures/infra_social_allyears.gph", replace
restore


****COMBINE
*combine:
grc1leg "../Figures/participaciones_allyears.gph" "../Figures/participables_allyears.gph" ///
"../Figures/fomento_allyears.gph" "../Figures/fortalecimiento_allyears.gph" ///
 "../Figures/infra_social_allyears.gph" "../Figures/aportaciones_allyears.gph" , ///
scheme(s1color)  imargin(vsmall)  col(3)  l1("Million pesos ") b1(" ")
graph export "../Figures/resouce_based_incumbency_allyears.png", as(png) replace
graph export "../Figures/resouce_based_incumbency_allyears.pdf", as(pdf) replace
graph export "../Figures/resouce_based_incumbency_allyears.tif", as(tif) replace
