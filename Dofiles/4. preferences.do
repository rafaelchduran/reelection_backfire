...
s(N r2 controls munfe yearfe clustermun wildci aggregate se_aggregate, fmt(%11.2gc 3) ///
 ...
 "p-value(aggregate)")) ///
keep($lagsleads) ///
mgroups("Narcotraffick" "Insecurity" "Punishment" "Corruption" "Poverty" "Unemployment" "Inflation" "Disasters" ///
...
coefplot (est1, rename((1) = "Narcotraffick") msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est2, rename((1) = "Insecurity") msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 ...
 (est5, rename((1) = "Poverty")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est6, rename((1) = "Unemployment")  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est7, rename((1) = "Inflation")  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est8, rename((1) = "Disaster")  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
  (est9, rename((1) = "Water")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est10, rename((1) = "Education")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est11, rename((1) = "Health")  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 , ///
...
tex & Narcotraffick & Insecurity & Punishment to criminals & Corruption  & Poverty & Unemployment & Inflation & Natural Disasters & Water Scarcity & Education & Health \\
...
coefplot  (est12, rename((1) = "Narcotraffick") msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est13, rename((1) = "Insecurity") msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 ...
 (est16, rename((1) = "Poverty")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 ...
 (est20, rename((1) = "Water")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est21, rename((1) = "Education")   msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 (est22, rename((1) = "Health")  msize(large) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *5) color(black black black))) ///
 , ///
 horizontal scheme(s1color)  xline(0)    ///
ytitle(" ")  xtitle("Term Limit Reform Average Effect" "from t to t+3") ///
subtitle("Topic that worries the most") legend(order(1 "99% CI" 2 "95% CI" 3 "90% CI") rows(1)) 
...
coefplot (est1, rename((1) = "Narcotraffick") msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est2, rename((1) = "Insecurity") msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 ...
 (est5, rename((1) = "Poverty")   msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est6, rename((1) = "Unemployment")  msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est7, rename((1) = "Inflation")  msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est8, rename((1) = "Disaster")  msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
  (est9, rename((1) = "Water")   msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est10, rename((1) = "Education")   msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est11, rename((1) = "Health")  msize(medium) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est12, rename((1) = "Narcotraffick") msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 ...
 (est18, rename((1) = "Inflation")  msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est19, rename((1) = "Disaster")  msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est20, rename((1) = "Water")   msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est21, rename((1) = "Education")   msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 (est22, rename((1) = "Health")  msize(medium) msymbol(S) mcolor(red) levels(99 95 90) ciopts(lwidth(*1 *3 *4) color(black black black))) ///
 , ///
 horizontal scheme(s1color)  xline(0)    ///
ytitle(" ")  xtitle("Term Limit Reform Average Effect" "from t to t+3") ///
