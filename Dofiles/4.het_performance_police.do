...
ap5_6_2_b  = ¿Cuánta confianza le inspira la (el) (AUTORIDAD)? policia preventiva municipal
ap5_6_8_b = ¿Cuánta confianza le inspira la (el) (AUTORIDAD)? ejercito
*/
*========================================================================
*Environment
clear all
...
************
cap drop inter_*
global split_variable ap5_6_1_b_mean
...
************
cap drop inter_*
global split_variable ap5_6_2_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_3_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_6_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_4_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_5_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_8_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
************
cap drop inter_*
global split_variable ap5_6_9_b_mean
foreach i in $split_variable{
foreach j in $saturated{
gen inter_`j'=`i'*`j'
}
...
*Table			
texdoc init  "../Tables/interaction_performance.tex", replace force
tex \begin{landscape}
tex \begin{table}[htbp]\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
tex \centering
tex \caption{Reform interaction with citizens' efficiency evaluation of police forces}
...
tex Efficiency Policy Force: & Traffic  & Preventive  & State Police & State Attorney Police & Federal Police & Ministerial Police & Army & Marines \\
...
texdoc init  "../Tables/interaction_performance_average.tex", replace force
tex \begin{landscape}
tex \begin{table}[htbp]\def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
tex \centering
tex \caption{Reform interaction with citizens' efficiency evaluation of police forces}
...
graph export "../Figures/performance_policeforces.png", as(png) replace
graph export "../Figures/performance_policeforces.pdf", as(pdf) replace
graph export "../Figures/performance_policeforces.tif", as(tif) replace
...
4 "Reform & Inefficient" 8 "Interaction (Reform & Efficient)" 12 "Tot. Interaction") size(small) rows(2) region(col(white))) 
graph export "../Figures/Performance_municipal.png", as(png) replace
graph export "../Figures/Performance_municipal.pdf", as(pdf) replace
graph export "../Figures/Performance_municipal.tif", as(tif) replace
graph save "../Figures/Performance_municipal.gph", replace
**State
...
4 "Reform & Inefficient" 8 "Interaction (Reform & Efficient)" 12 "Tot. Interaction") size(small) rows(2) region(col(white))) 
graph export "../Figures/Performance_state.png", as(png) replace
graph export "../Figures/Performance_state.pdf", as(pdf) replace
graph export "../Figures/Performance_state.tif", as(tif) replace
graph save "../Figures/Performance_state.gph", replace
**Federal
...
4 "Reform & Inefficient" 8 "Interaction (Reform & Efficient)" 12 "Tot. Interaction") size(small) rows(2) region(col(white))) 
graph export "../Figures/Performance_federal.png", as(png) replace
graph export "../Figures/Performance_federal.pdf", as(pdf) replace
graph export "../Figures/Performance_federal.tif", as(tif) replace
graph save "../Figures/Performance_federal.gph", replace

*combine:
grc1leg "../Figures/Performance_municipal.gph" "../Figures/Performance_state.gph" "../Figures/Performance_federal.gph" , ///
scheme(s1color)  imargin(vsmall) ycommon xcommon  col(1) t1("Efficiency") b1(Average Effect from t to t+3)
graph export "../Figures/performance_byforces.png", as(png) replace
graph export "../Figures/performance_byforces.pdf", as(pdf) replace
graph export "../Figures/performance_byforces.tif", as(tif) replace
graph save "../Figures/performance_byforces.gph", replace
...
4 "Reform & No Performance" 8 "Interaction (Reform & Performance)" 12 "Tot. Interaction") size(small) rows(2) region(col(white))) 
graph export "../Figures/Performance_policeforces2.png", as(png) replace
graph export "../Figures/Performance_policeforces2.pdf", as(pdf) replace
graph export "../Figures/Performance_policeforces2.tif", as(tif) replace
graph save "../Figures/Performance_policeforces2.gph", replace
*/
*========================================================================
*========================================================================
*========================================================================
