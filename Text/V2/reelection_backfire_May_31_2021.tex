...
%Even if delegation of security policy to governors is the most efficient choice for municipalities facing organized crime in Mexico, mayors with reelection incentives may choose not to delegate policy. The next section delves into why this could be the case. 
...
It is important, however, to differentiate  credit claiming from responsiveness. %a difference that centers on whether an incumbent addressed a problem or not, but decided to show his willingness to do so. 
...
%In the case of Mexico, the efficiency-electoral dilemma takes the following form. Mayors up for reelection.      
...
\subsection{Mechanisms: Heterogeneous Effects by the Level of Concern of Narcotraffic by Citizens}
...
\subsection{Consequences of Taking Charge of Security Policy: Violence and Security Underprovision \label{sec:unintended}}
\begin{comment}
