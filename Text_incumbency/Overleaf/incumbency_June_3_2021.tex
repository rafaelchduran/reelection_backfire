...
\label{tab:naive_twfe}
\scalebox{1}{ 
Dependent variables in Million pesos: & \multicolumn{2}{c}{General Participation Fund}  & \multicolumn{2}{c}{Participating Funds} & \multicolumn{2}{c}{Municipal Development Fund}  & \multicolumn{2}{c}{\begin{tabular}[c]{@{}l@{}}Contributions Fund to \\ Strengthen Municipalities \end{tabular}} & \multicolumn{2}{c}{\begin{tabular}[c]{@{}l@{}}Contribution Fund for \\ Municipal Social Infrastructure \end{tabular}}  & \multicolumn{2}{c}{\begin{tabular}[c]{@{}l@{}}Federal and State \\ Contributions (placebo) \end{tabular}} \\
