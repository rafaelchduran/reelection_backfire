...
\begin{tabular}{lcccc}
\hline \hline
\\ \multicolumn{3}{l}{Dependent variable: Signing a Security Cooperation Agreement w/ Governor}\\
...
\addlinespace
Average effect (from t to t+3)       & $-0.4197^{***} $$ & $-0.4197 ^{***} $$ & $-0.4605 ^{**} $$ & $-0.3553 ^{***} $$   \\
& (0.0457( & (0.0473)  & (0.1973) & (0.0466)  \\
\addlinespace
Observations       &      12,173 &      12,173 &      12,173 &      12,173 \\
R-squared         & 0.4542 & 0.4542 & 0.4542 & 0.4542 \\
