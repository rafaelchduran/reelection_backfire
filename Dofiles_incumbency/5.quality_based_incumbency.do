...
foreach i in $outcome6{
rdbwselect  `i' mv_incparty, c(0) p(1) kernel(tri) bwselect(CCT) 
global optimal = e(h_CCT)

areg  `i'  $saturated pol1 $interacted_pol1 $controls_time_acuerdo  i.year if mv_incparty<${optimal} & mv_incparty>-${optimal}, a(inegi) vce(cluster estado)
}
...
*------------------
*pol1  
foreach j in second_to_firsterm {
foreach pol in 1{
